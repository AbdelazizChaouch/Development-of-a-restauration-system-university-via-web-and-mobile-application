...
class Lunch {
  ...
  static Future<Lunch?> fetchLunchById(int id) async {
    final url = 'http://$_apiHost:3000/lunch/$id';

    try {
      print("Fetching lunch from: $url");
      ...
      if (response.statusCode == 200) {
        return Lunch.fromJson(jsonDecode(response.body));
      } else {
        print("Error: ${response.statusCode} - ${response.body}");
        return null;
      }
    } catch (e) {
      print("Failed to fetch lunch: $e");
      return null;
    }
  }
}
