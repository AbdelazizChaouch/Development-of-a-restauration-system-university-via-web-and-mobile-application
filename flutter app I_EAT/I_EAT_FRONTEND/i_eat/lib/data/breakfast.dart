...
class Breakfast {
  ...
  static Future<Breakfast?> fetchBreakfastById(int breakfastId) async {
    final url = 'http://$_apiHost:3000/breakfast/$breakfastId';

    try {
      print("Fetching breakfast from: $url");
      ...
      if (response.statusCode == 200) {
        return Breakfast.fromJson(json.decode(response.body));
      } else {
